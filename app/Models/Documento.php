...
class Documento extends Model {
    ...
    public function usuarioSube() { return $this->belongsTo(Usuario::class, 'id_usuario_sube'); }
    public function usuarioValida() { return $this->belongsTo(Usuario::class, 'id_usuario_valida'); }
}