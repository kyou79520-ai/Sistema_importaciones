...
class Importacion extends Model
{
    ...
    {
        return $this->belongsTo(EmpresaExtranjera::class, 'id_empresa_extranjera', 'id_empresa');
    }

    public function items()
    {
        return $this->hasMany(ItemImportacion::class, 'id_importacion');
    }

    public function documentos()
    {
        return $this->hasMany(Documento::class, 'id_importacion');
    }

    public function impuestos()
    {
        return $this->hasMany(Impuesto::class, 'id_importacion');
    }

    public function costos()
    {
        return $this->hasMany(CostoImportacion::class, 'id_importacion');
    }

    public function pagos()
    {
        return $this->hasMany(Pago::class, 'id_importacion');
    }
    ...
    public function logsSistemas()
    {
        return $this->hasMany(LogSistemaExterno::class, 'id_importacion');
    }
